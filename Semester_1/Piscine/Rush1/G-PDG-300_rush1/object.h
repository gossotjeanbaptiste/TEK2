...
typedef struct {
    const size_t        __size__;   // ex01 size
    const char          *__name__;  // ex01 name
    ctor_t              __ctor__;   // ex01 constructor
    dtor_t              __dtor__;   // ex01 destructor
    to_string_t         __str__;    // ex02 text represent
    binary_operator_t   __add__;    // ex03 addition
    binary_operator_t   __sub__;    // ex03 soustraction
    binary_operator_t   __mul__;    // ex04 multiplicaton
    binary_operator_t   __div__;    // ex04 division
    binary_comparator_t __eq__;     // ex04 equal to 
    binary_comparator_t __gt__;     // ex04 greater than
    binary_comparator_t __lt__;     // ex04 less than 
}   Class;
