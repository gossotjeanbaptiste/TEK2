...
int main(void)
{
    try {
        ...
        std::cout << "  Input:  " << nts::tristateToString(input1) << std::endl;
        ...
        std::cout << "  Input:  " << nts::tristateToString(input2) << std::endl;
        ...
        // Test 3: NOT(U) = U (Undefined stays Undefined)
        std::cout << std::endl << "Test 3: NOT(U) should output U (Undefined)" << std::endl;
        nts::Circuit circuit3;
        parser.parseFile("tests/files/test_not.nts", circuit3);
        // Don't set input - it stays Undefined
        circuit3.simulate();
        ...
        std::cout << "  Input:  " << nts::tristateToString(input3) << std::endl;
